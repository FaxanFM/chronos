...
```powershell
Get-FileHash .\chronos-v0.7.5.zip -Algorithm SHA256
gh attestation verify .\chronos-v0.7.5.zip -R FaxanFM/chronos
gh release verify v0.7.5 -R FaxanFM/chronos
gh release verify-asset v0.7.5 .\chronos-v0.7.5.zip -R FaxanFM/chronos
```
...
Compare the first command with `chronos-v0.7.5.sha256`. These controls prove
...
v0.7.5 retains disabled shared-folder write delegation. Inactive Governor
