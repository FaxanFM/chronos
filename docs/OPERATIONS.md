...
```powershell
Get-FileHash .\chronos-v0.7.2.zip -Algorithm SHA256
gh attestation verify .\chronos-v0.7.2.zip -R FaxanFM/chronos
gh release verify v0.7.2 -R FaxanFM/chronos
gh release verify-asset v0.7.2 .\chronos-v0.7.2.zip -R FaxanFM/chronos
```
...
Compare the first command with `chronos-v0.7.2.sha256`. These controls prove
...
version. v0.7.2 disables shared-folder write delegation. Inactive Governor
