...
GitHub release candidate: v0.8.4 keeps single-Governor supervision autonomous
and fixes upgrade recovery when prior Heartbeat state belongs to an
inaccessible sandbox identity. It has not been submitted, approved, or
published in the OpenAI Plugin Directory. The release artifact is
`chronos-v0.8.4.zip` with SHA-256
...
https://github.com/FaxanFM/chronos/releases/tag/v0.8.4.
...
5. Add a new version to the existing **Skills only** plugin and upload the final
   `chronos-v0.8.4.zip` release asset.
...
> Chronos for Codex v0.8.4 keeps one Terra Medium Governor per machine and
...
Review status: **v0.7.7 published; v0.8.4 not submitted**. Retained evidence
