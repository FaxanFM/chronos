...
It checks current resource health, explains signs of degradation, and offers conservative recovery steps without continuous monitoring.
...
Chronos mitigates local symptoms; it does not modify the Codex application.
